...
public class CartServiceTest {
    ...
    public void addNewItemToCart() {
        ...
        var product = new ProductCatalogItem(PRODUCT_ID, "test", "test", new BigDecimal("10.00"));
        ...
        verify(cartRepository, times(1)).findById(CART_ID);
        verify(productClient, times(1)).getProduct(PRODUCT_ID);
        verify(cartRepository, times(1)).save(any(Cart.class));
    }
    ...
    public void addCartItemProductNotFound() {
        ...
        when(cartRepository.findById(CART_ID)).thenReturn(Optional.of(cart));
        when(productClient.getProduct(PRODUCT_ID)).thenThrow(new ProductNotFoundException(PRODUCT_ID));
