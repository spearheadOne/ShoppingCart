...
public class CartService {
    ...
    public Cart addCartItem(Cart cart, CartItemAddRequest request, ProductCatalogItem productItem) {
    ...
    private CartItem toCartItem(ProductCatalogItem product, int quantity) {
        return new CartItem(
                product.id(),
                product.name(),
                product.imgUrl(),
